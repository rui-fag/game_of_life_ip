...
REM
REM Generated by Vivado on Mon Nov 06 18:52:19 +0000 2023
...
echo "xvlog --incr --relax -prj game_of_life_tb_vlog.prj"
call xvlog  --incr --relax -prj game_of_life_tb_vlog.prj -log xvlog.log
